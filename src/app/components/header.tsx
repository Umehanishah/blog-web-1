          ...
          <div className="border border-black items-center ">
            ...
            <div className="container w-[500px] md:w-[800px] py-10 px-10">
              ...
              <div className="flex gap-5 pt-5">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="red" stroke="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-heart">
