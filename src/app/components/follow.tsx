...
export default function Follow(){
    return(
        <>
        <div className="container  w-[300px] sm:w-[400px] md:w-[500px] lg:w-[400px] place-self-center md:place-self-auto">
            <Separator className="container  w-[300px] sm:w-[400px] place-self-center mt-20"/>
                <div className="pt-14  place-self-center">
                    <h2 className="text-xl tracking-[.30em] pb-10 font-light">
                        FOLLOW ME</h2>
                    </div>
                
                <div className="container  w-[300px] sm:w-[400px] grid grid-cols-2 gap-5 place-self-center md:place-self-auto">
                ...
                <Separator className="container  w-[300px] sm:w-[400px] mt-20"/>
                    <div className="flex gap-10 items-center container  w-[300px] sm:w-[350px] py-5 place-self-center">
                ...
                <Separator className="container  w-[300px] sm:w-[400px]"/>

                <div className="pt-14">
                    <h2 className="text-xl tracking-[.30em] pb-10 font-light">
                        SUBSCRIBE</h2>
                    </div>
                <div className="container  w-[300px] sm:w-[400px]">
                ...
                <Button className="bg-indigo-700 mt-5 rounded-none md:px-44">Submit</Button>
                </div>
                </div>
        </>
