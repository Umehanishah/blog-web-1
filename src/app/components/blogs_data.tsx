    ...
    <div className="container w-[400px] md:w-[800px] mx-auto ">
      ...
      {blogs.map((blogs) => (
        <Link href={`/blogs/${blogs.slug}`}>
          <div
            className="container w-[300px] sm:w-[450px] md:w-[800px] md:flex gap-5 my-5 mb-10 border border-black items-center place-self-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105  duration-300">
            ...
            <div className="container  w-[300px] sm:w-[400px] px-5 py-5 md:px-0 md:py-0">
            <h1 className="text-lg font-bold pt-4 text-black">
              {blogs.title}
            </h1>
            <p className="text-base text-gray-800 mt-2 pb-5">
              {blogs.description}
            </p>
              <hr/>
